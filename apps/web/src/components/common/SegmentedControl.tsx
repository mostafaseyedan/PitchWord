            ...
            <Tooltip.Root key={opt.value}>
              ...
              <Tooltip.Portal>
                <Tooltip.Content
                  side="top"
                  sideOffset={10}
                  className="z-[100000] max-w-[560px] rounded-xl bg-card-warm px-3 py-1.5 text-[12px] font-medium text-primary border border-border-warm shadow-[0_8px_24px_rgba(43,36,22,0.08)]"
                >
                  {opt.tooltip?.split("\n").map((line, i) => (
